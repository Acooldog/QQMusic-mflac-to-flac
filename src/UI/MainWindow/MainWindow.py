...
from src.Manager.qqmusic_decrypt import *

PLUGINS_CONFIG_PATH = os.path.join(os.path.dirname(__file__), "plugins", "plugins.json")
# PLUGINS_CONFIG_PATH = get_resource_path('plugins/plugins.json')
...
class MainWindow(QMainWindow):
    ...
    def load_message(self):
        ...
        # 添加按钮
        receive_btn = msg_box.addButton("收到", QMessageBox.AcceptRole)
        contact_btn = msg_box.addButton("联系作者", QMessageBox.ActionRole)
        source_btn = msg_box.addButton("查看开源链接", QMessageBox.ActionRole)
        ...
        if msg_box.clickedButton() == contact_btn:
            ...
            QDesktopServices.openUrl(QUrl("https://gitee.com/daoges_x/QQMusic-mflac-to-flac"))
